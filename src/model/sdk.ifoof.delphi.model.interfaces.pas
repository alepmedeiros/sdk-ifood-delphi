...
type
  ...
  iUserCode = interface
    function UserCode(Value: String): iUserCode; overload;
    function UserCode: String; overload;
    function AuthorizationCodeVerifier(Value: String): iUserCode; overload;
    function AuthorizationCodeVerifier: String; overload;
    function VerificationUrl(Value: String): iUserCode; overload;
    function VerificationUrl: String; overload;
    function VerificationUrlComplete(Value: String): iUserCode; overload;
    function VerificationUrlComplete: String; overload;
    function ExpiresIn(Value: Integer): iUserCode; overload;
    function ExpiresIn: Integer; overload;
    function JSON: iJobsJson<iUserCode>;
    function &End: iUserCode;
  end;

  iOAuthToken = interface
    function AccessToken(Value: String): iOAuthToken; overload;
    function AccessToken: String; overload;
    function &Type(Value: String): iOAuthToken; overload;
    function &Type: String; overload;
    function ExpiresIn(Value: Integer): iOAuthToken; overload;
    function ExpiresIn: Integer; overload;
    function JSON: iJobsJson<iUserCode>;
    function &End: iOAuthToken;
  end;

//  iMerchants = interface
//    function Id(Value: String): iMerchants; overload;
//    function Id: String; overload;
//    function Name(Value: String): iMerchants; overload;
//    function Name: String; overload;
//    function CorporateName(Value: String): iMerchants; overload;
//    function CorporateName: String; overload;
//    function JSON: iJobsJson<iMerchants>;
//    function &End: iMerchants;
//  end;
//
//  iMetadata<T: IInterface> = interface
//    function Description(Value: String): iMetadata<T>; overload;
//    function Description: String; overload;
//    function &End: T;
//  end;
//
//  iEventPolling = interface
//    function CreateAt(Value: TDateTime): iEventPolling; overload;
//    function CreateAt: TDateTime; overload;
//    function FullCode(Value: TOrderFullCode): iEventPolling; overload;
//    function FullCode: TOrderFullCode; overload;
//    function Metadata: iMetadata<iEventPolling>;
//    function Code(Value: TOrderTypeCode): iEventPolling; overload;
//    function Code: TOrderTypeCode; overload;
//    function OrderId(Value: String): iEventPolling; overload;
//    function OrderId: String; overload;
//    function Id(Value: String): iEventPolling; overload;
//    function Id: String; overload;
//    function &End: iEventPolling;
//  end;
